...
//    virtual bool GetRange(const std::string &key, std::shared_ptr<int8_t> value) = 0;
    ...
    virtual void LoadInMemory_(std::map<std::string, ValueInfo>& local_storage) = 0;
};
...
public:
    ...
    bool Get(const std::string &key, std::shared_ptr<int8_t>& value_out, size_t& size_out) override;
    bool Set(const std::string &key, const std::shared_ptr<int8_t>& value_in, size_t size_in) override;
//    bool GetRange(const std::string &key, int8_t* value) override;
    ...
    void LoadInMemory_(std::map<std::string, ValueInfo>& local_storage) override;
