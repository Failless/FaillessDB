...
public:
    ...
    virtual bool Set(const string &key, const std::shared_ptr<int8_t>& value_in, size_t size_in) = 0;
...
public:
    ...
    bool Set(const string &key, const std::shared_ptr<int8_t>& value_in, size_t size_in) override;
